(function(/*! Brunch !*/) {
  ...
  "views/inputs/BaseInputView": function(exports, require, module) {
    (function() {
  var __hasProp = Object.prototype.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor; child.__super__ = parent.prototype; return child; };

  exports.BaseInputView = (function(_super) {

    __extends(BaseInputView, _super);

    function BaseInputView() {
      BaseInputView.__super__.constructor.apply(this, arguments);
    }

    BaseInputView.prototype.initialize = function() {};
...
(this.require.define({
  "views/factories/formular_factory": function(exports, require, module) {
    (function() {
  var Formular, InputView, OutputView, Slider;

  Formular = require('models/formular').Formular;

  OutputView = require('views/output').OutputView;

  InputView = require('views/input').InputView;

  Slider = require('views/slider').Slider;
  ...
  exports.FormularFactory = (function() {
    ...
    FormularFactory.prototype.create = function(parent) {
      ...
      model = new Formular;
      output = new OutputView(model, this.paper);
      input = new InputView({
        model: model,
        parent: parent,
        slider: this.slider
...
(this.require.define({
  "views/input": function(exports, require, module) {
    (function() {
  var __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    __hasProp = Object.prototype.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor; child.__super__ = parent.prototype; return child; };
  ...
  exports.InputView = (function(_super) {
    ...
    InputView.prototype.changeFormular = function(event) {
      this.model.setFormular($(this.el).val());
      this.slider.show(this.el, this.sliderCallback);
      return this;
    };
...
(this.require.define({
  "views/output": function(exports, require, module) {
    (function() {
  var __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };

  exports.OutputView = (function() {

    function OutputView(model, paper) {
      this.model = model;
      this.paper = paper;
      this.render = __bind(this.render, this);
      this.model.bind('change', this.render);
    ...
    OutputView.prototype.createPoint = function(x) {
      var y;
      y = this.calculateY(x);
      if (typeof y === 'number') {
        return "" + (x ? 'L' : 'M') + " " + x + " " + y;
    ...
    OutputView.prototype.calculateY = function(x) {
      try {
        return eval(this.model.get('formular').replace('x', x));
      } catch (e) {
        return null;
...
(this.require.define({
  "views/slider": function(exports, require, module) {
    (function() {
  var __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    __hasProp = Object.prototype.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor; child.__super__ = parent.prototype; return child; };
